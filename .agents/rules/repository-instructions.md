...
- When creating development branches, use the agent's recognized identifier prefix (e.g. `antigravity/<feature>`, `codex/<feature>`) or clean milestone branch names (`milestone-<number>`).
