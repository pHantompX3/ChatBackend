...
description: Use when auditing or restructuring repository context architecture, Copilot customization, AI instruction routing, authoritative documentation layout, AGENTS.md/copilot-instructions/instructions/prompts/agents/skills organization, or cold-agent onboarding/discoverability. Do not use for ordinary feature coding that does not change workspace context architecture.
---
...
This skill performs conservative, evidence-based workspace context architecture work for this repository. It prioritizes discoverability, canonical sources, scoped routing, and low-noise Copilot context loading.
...
- creating or refining scoped .instructions.md files
...
3. Use Copilot surface semantics in [references/copilot-context-surfaces.md](references/copilot-context-surfaces.md).
