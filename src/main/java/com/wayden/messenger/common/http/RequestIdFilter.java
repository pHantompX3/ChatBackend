...
public class RequestIdFilter implements ContainerRequestFilter, ContainerResponseFilter {
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        String traceId = Optional.ofNullable(requestContext.getHeaderString(TRACE_ID_HEADER))
        ...
        payload.put("query", Optional.ofNullable(requestContext.getUriInfo().getRequestUri().getQuery()).orElse("-"));
        payload.put("userAgent", Optional.ofNullable(requestContext.getHeaderString("User-Agent")).orElse("-"));

        LOG.infof(
            "=== ENTRY FILTER: New Request Received ===%n%s",
