...
public class HttpAuditFilter implements ContainerRequestFilter, ContainerResponseFilter {
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        String userAgent = Optional.ofNullable(requestContext.getHeaderString("User-Agent")).orElse("-");
        String forwardedFor = Optional.ofNullable(requestContext.getHeaderString("X-Forwarded-For")).orElse("-");
        ...
        ClientIpResolution clientIpResolution = resolveClientIp(forwardedFor, xRealIp, forwarded, httpServerRequest);
